...
public class deleteprimeRecycler extends RecyclerView.Adapter<deleteprimeRecycler.ViewHolder> {

    private Context context;
    private List<teammodel> MainImageUploadInfoList;


    public deleteprimeRecycler(Context context, List<teammodel> TempList) {
    ...
    @Override
    public deleteprimeRecycler.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.deleteprimelayout, parent, false);

        deleteprimeRecycler.ViewHolder viewHolder = new deleteprimeRecycler.ViewHolder(view);

        return viewHolder;
    }

    @Override
    public void onBindViewHolder(final deleteprimeRecycler.ViewHolder holder, int position) {
        ...
        holder.Delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               ...
               DatabaseReference reference= FirebaseDatabase.getInstance().getReference("Members Details").child("Prime Core");
