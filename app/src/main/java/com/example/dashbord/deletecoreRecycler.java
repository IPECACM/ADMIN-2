...
public class deletecoreRecycler extends RecyclerView.Adapter<deletecoreRecycler.ViewHolder> {

    private Context context;
    private List<teammodel> MainImageUploadInfoList;


    public deletecoreRecycler(Context context, List<teammodel> TempList) {
    ...
    @Override
    public deletecoreRecycler.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.deletecorelayout, parent, false);

        deletecoreRecycler.ViewHolder viewHolder = new deletecoreRecycler.ViewHolder(view);

        return viewHolder;
    }

    @Override
    public void onBindViewHolder(final deletecoreRecycler.ViewHolder holder, int position) {
            ...
            public void onClick(View view) {
                ...
                builder.setPositiveButton("yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        DatabaseReference reference= FirebaseDatabase.getInstance().getReference("Members Details").child("Core Members");
